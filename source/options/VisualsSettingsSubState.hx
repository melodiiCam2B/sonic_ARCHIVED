...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('GITHUB Counter',
		...
		var option:Option = new Option('DEBUG Counter',
		...
		var option:Option = new Option('Script Counter',
		...
		var option:Option = new Option('All Counters',
