...
class Credits extends MusicBeatState{
    ...
    //  ['name', 'what they did', 'extra stuff', 'social link']
        ...
        ['Psych Engine Team'],
        ['Shadow Mario', 'Main Programmer and Head of Psych Engine', '', 'https://ko-fi.com/shadowmario'],
        ['Riveren', 'Main Artist/Animator of Psych Engine', '', 'https://x.com/riverennn'],

        ['Former Engine Members'],
        ['bb-panzu', 'Ex-Programmer of Psych Engine', '', 'https://x.com/bbsub3'],

        ['Engine Contributors'],
        ['crowplexus', 'Linux Support, HScript Iris, Input System v3, and Other PRs', '', 'https://twitter.com/IamMorwen'],
        ['Kamizeta', 'Creator of Pessy, Psych Engine\'s mascot', '', 'https://www.instagram.com/cewweey/'],
        ['MaxNeton', 'Loading Screen Easter Egg Artist/Animator', '', 'https://bsky.app/profile/maxneton.bsky.social'],
        ['Keoiki', 'Note Splash Animations and Latin Alphabet', '', 'https://x.com/Keoiki_'],
        ['SqirraRNG', 'Chart Editor\'s Waveform', '', 'https://x.com/gedehari'],
        ['EliteMasterEric', 'Runtime Shaders support and Other PRs', '', 'https://x.com/EliteMasterEric'],
        ['MAJigsaw77', '.MP4 Video Loader Library (hxvlc)', '', 'https://x.com/MAJigsaw77'],
        ['iFlicky', 'Composer of Psync and Tea Time and some sound effects', '', 'https://x.com/flicky_i'],
        ['KadeDev', 'Fixed some issues on Chart Editor and Other PRs', '','https://x.com/kade0912'],
        ['superpowers04', 'LUA JIT Fork', '','https://x.com/superpowers04'],
        ['CheemsAndFriends', 'Creator of FlxAnimate', '','https://x.com/CheemsnFriendos'],
    ...
    override public function create(){
		...
		descBox.makeGraphic(Std.int(FlxG.width- 40),Std.int(FlxG.height/4) , FlxColor.BLACK);
	...
	function changeOption(?i:Int = 0){
        ...
        setText(creditsStuff[curSelected][1], descJob);
        setText(creditsStuff[curSelected][2], descTxt);
