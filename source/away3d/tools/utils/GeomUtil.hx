...
class GeomUtil {
	 ...
	 */
	public static function fromVectors(verts:Vector<Float>, indices:Vector<UInt>, uvs:Vector<Float>, normals:Vector<Float>, tangents:Vector<Float>,
			weights:Vector<Float>, jointIndices:Vector<Float>, triangleOffset:Int = 0):Vector<ISubGeometry> {
		...
		if ((indices.length >= LIMIT_INDICES) || (verts.length >= LIMIT_VERTS)) {
			...
			var splitIndex:Int;
			var o0:Int, o1:Int, o2:Int, s0:Int, s1:Int, s2:Int, su:Int, ou:Int, sv:Int, ov:Int;
	 ...
	 */
	public static function constructSubGeometry(verts:Vector<Float>, indices:Vector<UInt>, uvs:Vector<Float>, normals:Vector<Float>, tangents:Vector<Float>,
			weights:Vector<Float>, jointIndices:Vector<Float>, triangleOffset:Int):CompactSubGeometry {
	 ...
	 */
	public static function interleaveBuffers(numVertices:Int, vertices:Vector<Float> = null, normals:Vector<Float> = null, tangents:Vector<Float> = null,
			uvs:Vector<Float> = null, suvs:Vector<Float> = null):Vector<Float> {
		var i:Int = 0,
			compIndex:Int,
			uvCompIndex:Int,
			interleavedCompIndex:Int;
