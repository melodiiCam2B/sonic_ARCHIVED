...
class UtilFont extends FlxText {
	...
	public function new(x:Float = 0, y:Float = 0, text:String, ?bold:Bool = false) {
		...
		borderSize = 5;
		setFormat(Paths.font("DTM-Mono.otf"), 46, (bold? FlxColor.WHITE : FlxColor.BLACK), LEFT, FlxTextBorderStyle.OUTLINE,(bold? FlxColor.BLACK : FlxColor.TRANSPARENT));
	}
