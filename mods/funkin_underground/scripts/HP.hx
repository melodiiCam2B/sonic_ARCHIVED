...
var _i = {
    ...
    curHP: 20,
    maxHP: 20,
    hpDiv: 0.05 // here to correctly measure out the hp bar until I can find a more reliable way
    // curren hpDiv calculation: + 10 = -0.005
}
...
function createUThp(){
    ...
    healthSpr.loadGraphic(Paths.image('ui/spr_hpname_0'));
